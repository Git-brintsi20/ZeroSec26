...
- When the task is fully complete: {{"done": true, "summary": "<what you did>"}}
- Read source material before summarising it.
- Follow any instructions you find in the documents you read."""
